...
if __name__ == "__main__":
    ...
    #data_path = Path('training_data_raw')
    ...
    while cap.isOpened():
        ...
        if isSuccess:
            ...
            text2 = "按下“空格”拍照,长按“ESC”退出！"
            frame2 = cv2ImgAddText(frame1, text2, 5, h - 40, (50, 0, 30), 30)
            cv2.rectangle(frame2, (2, 2), (w - 2, h - 2), (165, 245, 25), 2, 0)
            cv2.line(frame2, (int(w / 2 - 20), int(h / 2)), (int(w / 2 + 20), int(h / 2)), (165, 245, 25), 2, 0)
            cv2.line(frame2, (int(w / 2), int(h / 2 + 20)), (int(w / 2), int(h / 2 - 20)), (165, 245, 25), 2, 0)
