...
def producer(args, q1):
    if args.webcam is True:
        ...
        video_capture.set(3, 1280)  # 设置分辨率，宽度
        video_capture.set(4, 720)  # 高度
...
def main(args, q1, q2, q3):
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            video_recording = cv2.VideoWriter(args.respath + '/res_video/output.avi', fourcc, 10,
                                              (width, height))
                ...
                if faces_found > 0:
                    ...
                    for i in range(faces_found):
                            ...
                            if bb[i][0] > xmin and bb[i][2] < xmax and bb[i][1] > ymin and bb[i][3] < ymax:
                                ...
                                if area >= window_area*0.25:
                                    ...
                                    if tems > 20:
                                        ...
                                        cv2.putText(frame2, '{}'.format(tems), (bb[i][0]+5, bb[i][1]+35),
                                                    font,
                        ...
                        if best_class_probabilities > 0.3:
                            ...
                            cv2.putText(frame2, id_score, (bb[i][0] + 5, bb[i][1] - 3),
                                        font,
                        ...
                        if best_class_probabilities > args.knowperson_threshold:  # 0.90:
                            ...
                            #               cv2.FILLED)  # name box
                            font = cv2.FONT_HERSHEY_COMPLEX_SMALL  # cv2.FONT_HERSHEY_SCRIPT_COMPLEX #cv2.FONT_HERSHEY_COMPLEX_SMALL,
                            cv2.putText(frame2, class_names[best_class_indices[0]], (text_xmin+5, text_y),
                                        font,
